...
namespace ShoppingCart.Infrastructure.Migrations
{
    ...
    [Migration("20240517061303_add cart create and update date in user cart table")]
    partial class addcartcreateandupdatedateinusercarttable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShoppingCart.Domain.Models.UserCart", b =>
                {
                    ...
                    b.Property<DateTime>("cartCreateDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("cartUpdateDate")
                        .HasColumnType("datetime2");
